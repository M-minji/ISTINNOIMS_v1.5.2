			...
			<div class="filter_wrap">
				<div class="search_filter">
					<ul>
						...
						<li>
							<span>제조사</span>
							<input type="text" id="searchTypeSet4" name="searchTypeSet4"  class="searchWord" value="${mesAssetVO.searchTypeSet4}" />
						</li>
						<li>
							<span>모델명</span>
							<input type="text" id="searchTypeSet5" name="searchTypeSet5" class="searchWord" value="${mesAssetVO.searchTypeSet5}" />
						</li>
		<!-- 				<li> -->
