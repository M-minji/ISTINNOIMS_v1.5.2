		...
		<table>
			<tbody>
        		...
        		<tr>
        			<th>내구연수</th>
					<td colspan="1">
            			<input type="text" name="eLifespan" id="eLifespan" style="width:150px; text-align:left; padding-right: 5px;" maxLength="2" value="" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"  onchange="eLifCheck()"  /> : (연 단위)
